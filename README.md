The program prompts the user to answer how many motors are available, when the user inputs this into a new prompt will ask the user how many kg's of packages are expected. 
